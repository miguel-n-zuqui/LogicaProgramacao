programa
{
	...
	funcao seletor_programa(cadeia opcao_p)
	{
		real opcao_real
		inteiro opcao_inteiro
		caracter opcao_caracter
		opcao_caracter=ti.cadeia_para_caracter(opcao_p)
		escolha(opcao_caracter)
		{
			caso '1':
				tela_inss()
  			pare
		...
		opcao_real=ti.cadeia_para_real(opcao_p)
		opcao_inteiro= ti.real_para_inteiro(opcao_real)
 ...
 * 
 * @POSICAO-CURSOR = 30674; 
 * @DOBRAMENTO-CODIGO = [11, 19, 27, 55, 121, 145, 203, 255, 288, 324, 357, 379, 413, 421, 452, 465, 625, 651, 708, 734, 766, 796, 837, 857, 885, 905, 912, 941, 972, 1048, 1076, 1106, 1146, 1267];
 * @PONTOS-DE-PARADA = ;
